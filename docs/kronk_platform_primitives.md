...
| `<StandardCard>`                                                                    | The one shell every Kronk card is built on — six named slots, three arrangements (feed / portrait / grid).                    | `components/standard_card.tsx`. Spec: [`docs/kronk_card_standard.md`](kronk_card_standard.md).                                                                    |
