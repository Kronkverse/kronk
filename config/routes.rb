...
Rails.application.routes.draw do
  ...
  # Wachuneed legacy aliases. `/hub/wachuneed` is the canonical URL as
  # of 2026-09-07 (flipped back from `/hub/martketplace`); every prior
  # name resolves via 301 for one release. Kept indefinitely — these
  # URLs are in already-projected feed cards and in users' bookmarks.
