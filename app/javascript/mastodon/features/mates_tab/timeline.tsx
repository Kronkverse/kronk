      ...
      <div className='mates-tab__canvas'>
        ...
        <div className='mates-tab__scroller'>
          ...
          >
            ...
            {/* Inviter link — a curve from the inviter tile to the head cap */}
            {inviter && inviterJoinX !== null && (
              <path
                d={`M ${inviterJoinX} ${lineY} C ${(inviterJoinX + subjectJoinX) / 2} ${lineY}, ${(inviterJoinX + subjectJoinX) / 2} ${lineY}, ${subjectJoinX} ${lineY}`}
...
const TimelineTile: React.FC<TimelineTileProps> = ({
  ...
  return (
    <g
      className={`mates-tab__tile mates-tab__tile--${variant}`}
