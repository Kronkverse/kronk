...
class CreateWhatchuneedResponses < ActiveRecord::Migration[8.0]
  def change
    ...
    add_foreign_key :whatchuneed_responses, :whatchuneed_listings, column: :listing_id, on_delete: :cascade
    add_foreign_key :whatchuneed_responses, :accounts, on_delete: :cascade
  end
end
